...
public class DataBase extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO RULE VALUES (2,'Present continuous', 'Present continuous : present of « to be » + the present participle of the main verb. It is use about something that is unfinished or incomplete.','Présent continu : auxiliaire « be » (être) au présent simple + participe présent (forme verbale en -ing). Il s''utilise pour des actions non finies ou incomplètes.')");
        db.execSQL("INSERT INTO RULE VALUES (3,'Present perfect','Present perfect : the appropriate form of the auxiliary verb to have (present) + the past participle of the main verb. It is used to indicate a link between the present and the past. The time of the action is before now.','Present perfect : bonne forme de l''auxiliaire « have » (au présent simple) + participe passé du verbe principal. Il est utilisé pour indiqué un lien entre le présent et le passé. L''action se déroule dans le passé.')");
        db.execSQL("INSERT INTO RULE VALUES (4,'Past simple','The simle past tense, also called preterite, is used to talk about a habit or a completed action in a time before now. Verbs are finished with -ed.', 'Le prétérit est utilisé pour décrire une action finie ou une habitude dans le passé. Les verbes finissent par -ed.')");
        db.execSQL("INSERT INTO RULE VALUES (5,'Past continuous','Past continuous : past tense of the verb « to be » (was/were) + base of the main verb +ing. It describes actions or events in a time before now, which began in the past and is still going on at the time of speaking. It expresses an unfinished or incomplete action in the past.', 'Passé continu : prétérit du verbe « to be » (être) + verbe principal +ing. Il décrit des événements qui ont commencés dans le passé et sont encore en cours au moment où on parle. Il exprime une action non finie ou incomplète dans le passé.')");
